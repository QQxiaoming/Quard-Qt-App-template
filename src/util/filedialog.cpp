    ...
    , ui(new Ui::FileDialog)
{
    ...
    newbox->addButton("添加",QDialogButtonBox::AcceptRole);
    newbox->addButton("移除",QDialogButtonBox::RejectRole);
    ...
    QPushButton *clearButton = new QPushButton("清除所有", this);
    ...
    this->layout()->addWidget(new QLabel("已选择:",this));
